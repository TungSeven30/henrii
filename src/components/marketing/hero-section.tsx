...
const HERO_BG = "/marketing/hero-bg.webp";
const APP_MOCKUP = "/marketing/app-mockup.webp";
const HERO_BG_FALLBACK = "/marketing/hero-bg.webp";
const APP_MOCKUP_FALLBACK = "/marketing/app-mockup.webp";
