...
const HERO_BG =
  "https://private-us-east-1.manuscdn.com/sessionFile/Yqb0N7s7iBUqXrW0bKMS7H/sandbox/75QFX0jm1OtJUTcKpssxoq-img-1_1770630639000_na1fn_aGVucmlpLWhlcm8tYmc.png?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Policy=&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=T9GAftjVpPt-UzoXS3DVFLaNsx9mAG-slxpwdIQkY7R5-gjXNANdsx7zPfmswLfW4zJVgLmWKnp8~3~9QLY7RCxPOw3KSvk1pvatSWJaY5KrZbZDHeJopei9RpmnGk1iro7I6J-1YbRK1oioZ5c11ol7VTKd6QuHQfwPTsPEYhN2PzESrR3pCDQhENT~iiqIUfCVZAJcEqLwYrItNxinn0vZJmSvQ50YWG6P58LgbcXjYfgYnref5nzbxkiPWuA7hLmLRbbOdqcj5G4z71YRRGi8ZYV9brxn9oBllw3T5LqdLaXXGKDthpkNQZU6~skB6bU6stSxX7tvRC7pqZV51Q__";
const APP_MOCKUP =
...
function FloatingMockup() {
  return (
    <div className="relative mx-auto w-[280px] sm:w-[340px] md:w-[390px] lg:w-[440px]">
      <div className="pointer-events-none absolute -top-16 -left-14 h-36 w-36 rounded-full bg-henrii-blue/35 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-12 -right-12 h-40 w-40 rounded-full bg-henrii-pink/35 blur-3xl" />
      <div className="pointer-events-none absolute right-0 top-8 h-36 w-36 rounded-full bg-henrii-cream/25 blur-3xl" />
      <img
        src={APP_MOCKUP}
    ...
    <section className="relative min-h-[90dvh] flex items-center overflow-hidden pt-16 md:pt-20">
      ...
      <div className="relative z-10 w-full py-12 md:py-20">
        <div className="container relative">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-12">
            <AnimateIn>
              <div className="max-w-xl">
                ...
                <h1 className="mt-6 font-heading text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[1.08] text-foreground">
                  {t("headline")}
                </h1>
                <p className="mt-6 max-w-md text-lg md:text-xl leading-relaxed text-muted-foreground">
                  {t("subheadline")}
                </p>
                <div className="mt-8 flex flex-wrap gap-3">
                  ...
                  <Button size="lg" variant="outline" asChild>
                    <a href="#features">{t("secondary_cta")}</a>
                  </Button>
                </div>
